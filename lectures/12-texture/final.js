...
const fragmentShaderSource = `#version 300 es
    ...
    void main() {
        ...
        vec3 ambientColor = texture(u_ambientTexture, f_textureCoordinate).rgb;
        ...
        float specularFactor = pow(max(0.0, dot(normal, halfway)), 128.0);
...
// Texture.
const diffuseTexture = await loadTexture(gl, "https://surfer.teledu.app/hfu/lectures/texture/earth-diffuse.webp");
const specularTexture = await loadTexture(gl, "https://surfer.teledu.app/hfu/lectures/texture/earth-specular.webp");
const ambientTexture = await loadTexture(gl, "https://surfer.teledu.app/hfu/lectures/texture/earth-ambient.webp");
...
function myRenderLoop({ globalTime })
{
    ...
    gl.bindTexture(gl.TEXTURE_2D, specularTexture.glo);
    gl.activeTexture(gl.TEXTURE0 + 2);
    gl.bindTexture(gl.TEXTURE_2D, ambientTexture.glo);
    ...
    drawCall.uniform.u_diffuseTexture = 0; // texture unit 0
    drawCall.uniform.u_specularTexture = 1;
    drawCall.uniform.u_ambientTexture = 2;
