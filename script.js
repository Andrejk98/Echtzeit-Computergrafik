...
const bishopGeo = await glance.loadObj("https://surfer.teledu.app/hfu/geometry/chess-bishop.obj");
const pawnGeo = await glance.loadObj("https://surfer.teledu.app/hfu/geometry/chess-pawn.obj");
const queenGeo = await glance.loadObj("https://surfer.teledu.app/hfu/geometry/chess-queen.obj");
const rookGeo = await glance.loadObj("https://surfer.teledu.app/hfu/geometry/chess-rook.obj");
...
const piecesWhiteDiffuse = await glance.loadTexture(gl, "https://surfer.teledu.app/hfu/textures/chess-pieces-white-diffuse.webp");
const piecesWhiteSpecular = await glance.loadTexture(gl, "https://surfer.teledu.app/hfu/textures/chess-pieces-white-specular.webp");
...
const bishopDrawCall = createDrawCall(bishopGeo, "bishop");
const queenDrawCall = createDrawCall(queenGeo, "queen");
const pawnDrawCall = createDrawCall(pawnGeo, "pawn");
const rookDrawCall = createDrawCall(rookGeo, "rook");
...
function renderLoop({ globalTime })
{
    ...
    // Knight
    renderDrawCall(knightDrawCall, viewPosition, piecesBlackDiffuse, piecesBlackSpecular, Mat4.translate(-0.9, 0.17, 0.3).rotateY(Math.PI + 0.4));
    renderDrawCall(knightDrawCall, viewPosition, piecesWhiteDiffuse, piecesWhiteSpecular, Mat4.translate(2, 0.17, 0.9).rotateY(Math.PI + 3.4));

    // Rook
    renderDrawCall(rookDrawCall, viewPosition, piecesBlackDiffuse, piecesBlackSpecular, Mat4.translate(-2, 0.17, -2).rotateY(Math.PI + 0.4));
    renderDrawCall(rookDrawCall, viewPosition, piecesBlackDiffuse, piecesBlackSpecular, Mat4.translate(2, 0.17, -1.45).rotateY(Math.PI + 0.4));
    renderDrawCall(rookDrawCall, viewPosition, piecesWhiteDiffuse, piecesWhiteSpecular, Mat4.translate(-2, 0.17, 0.9).rotateY(Math.PI + 3));
    renderDrawCall(rookDrawCall, viewPosition, piecesWhiteDiffuse, piecesWhiteSpecular, Mat4.translate(2, 0.17, 2).rotateY(Math.PI + 3));

    // Queen
    renderDrawCall(queenDrawCall, viewPosition, piecesBlackDiffuse, piecesBlackSpecular, Mat4.translate(-0.3, 0.17, -2).rotateY(Math.PI + 0.4));
    renderDrawCall(queenDrawCall, viewPosition, piecesWhiteDiffuse, piecesWhiteSpecular, Mat4.translate(0.3, 0.17, 2).rotateY(Math.PI + 3));

    // Pawn
    renderDrawCall(pawnDrawCall, viewPosition, piecesBlackDiffuse, piecesBlackSpecular, Mat4.translate(-0.3, 0.17, -1.4).rotateY(Math.PI + 0.4));
    renderDrawCall(pawnDrawCall, viewPosition, piecesBlackDiffuse, piecesBlackSpecular, Mat4.translate(0.3, 0.17, -1.4).rotateY(Math.PI + 0.4));
    renderDrawCall(pawnDrawCall, viewPosition, piecesBlackDiffuse, piecesBlackSpecular, Mat4.translate(-0.85, 0.17, -1.4).rotateY(Math.PI + 0.4));
    renderDrawCall(pawnDrawCall, viewPosition, piecesBlackDiffuse, piecesBlackSpecular, Mat4.translate(0.85, 0.17, -1.4).rotateY(Math.PI + 0.4));
    renderDrawCall(pawnDrawCall, viewPosition, piecesBlackDiffuse, piecesBlackSpecular, Mat4.translate(0.85, 0.17, -1.4).rotateY(Math.PI + 0.4));
    renderDrawCall(pawnDrawCall, viewPosition, piecesBlackDiffuse, piecesBlackSpecular, Mat4.translate(-2, 0.17, -0.9).rotateY(Math.PI + 0.4));
    renderDrawCall(pawnDrawCall, viewPosition, piecesBlackDiffuse, piecesBlackSpecular, Mat4.translate(2, 0.17, 0.3).rotateY(Math.PI + 0.4));
    renderDrawCall(pawnDrawCall, viewPosition, piecesWhiteDiffuse, piecesWhiteSpecular, Mat4.translate(-0.3, 0.17, 1.4).rotateY(Math.PI + 0.4));
    renderDrawCall(pawnDrawCall, viewPosition, piecesWhiteDiffuse, piecesWhiteSpecular, Mat4.translate(0.3, 0.17, 1.4).rotateY(Math.PI + 0.4));
    renderDrawCall(pawnDrawCall, viewPosition, piecesWhiteDiffuse, piecesWhiteSpecular, Mat4.translate(-0.85, 0.17, 1.4).rotateY(Math.PI + 0.4));
    renderDrawCall(pawnDrawCall, viewPosition, piecesWhiteDiffuse, piecesWhiteSpecular, Mat4.translate(0.85, 0.17, 1.4).rotateY(Math.PI + 0.4));
    renderDrawCall(pawnDrawCall, viewPosition, piecesWhiteDiffuse, piecesWhiteSpecular, Mat4.translate(-0.85, 0.17, 0.9).rotateY(Math.PI + 0.4));
